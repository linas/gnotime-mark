...
edit_plugin_dialog_new (void)
{
  ...
  gtk_box_pack_start (GTK_BOX (action_area), cancelbutton1, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (action_area), applybutton1, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbuttonbox1), up_button, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbuttonbox1), down_button, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbuttonbox1), left_button, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbuttonbox1), right_button, TRUE, TRUE, 0);
  ...
  GtkWidget *const icon_path = gtk_file_chooser_button_new (
      _ ("Select a File"), GTK_FILE_CHOOSER_ACTION_OPEN);
  ...
  gtk_table_attach (GTK_TABLE (table1), icon_path, 1, 2, 3, 4,
                    GTK_EXPAND | GTK_FILL, GTK_EXPAND | GTK_FILL, 0, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox2), entry4, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (content_area), hbox1, TRUE, TRUE, 0);
