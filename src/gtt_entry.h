...
#define GTT_ENTRY(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), GTT_TYPE_ENTRY, GttEntry))
#define GTT_ENTRY_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST ((klass), GTT_TYPE_ENTRY, GttEntryClass))
#define GTT_IS_ENTRY(obj) (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GTT_TYPE_ENTRY))
#define GTT_IS_ENTRY_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), GTT_TYPE_ENTRY))
...
void gtt_entry_prepend_history (GttEntry *gentry, gboolean save,
                                const gchar *text);
void gtt_entry_append_history (GttEntry *gentry, gboolean save,
                               const gchar *text);
