...
{
  GtkWidget *const active_dialog = gtk_dialog_new ();
  ...
  g_signal_connect (G_OBJECT (active_dialog), "destroy",
                    G_CALLBACK (dialog_close), id);

  GtkWidget *const content_area
      = gtk_dialog_get_content_area (GTK_DIALOG (active_dialog));
  ...
  GtkWidget *const project_option_menu = gtk_option_menu_new ();
  ...
  GtkWidget *const project_menu = gtk_menu_new ();
  ...
  GtkWidget *const time_credit_entry = gtk_entry_new ();
  ...
  GtkWidget *const action_area
      = gtk_dialog_get_action_area (GTK_DIALOG (active_dialog));
  ...
  g_signal_connect (G_OBJECT (helpbutton1), "clicked",
                    G_CALLBACK (dialog_help), id);
  gtk_widget_show (helpbutton1);

  gtk_box_pack_start (GTK_BOX (action_area), helpbutton1, TRUE, TRUE, 0);

  GtkWidget *const yes_button = gtk_button_new_from_stock (GTK_STOCK_EXECUTE);
  ...
  g_signal_connect (G_OBJECT (yes_button), "clicked", G_CALLBACK (start_proj),
                    id);
  gtk_widget_show (yes_button);

  gtk_box_pack_start (GTK_BOX (action_area), yes_button, TRUE, TRUE, 0);

  GtkWidget *const no_button = gtk_button_new_from_stock (GTK_STOCK_CANCEL);
