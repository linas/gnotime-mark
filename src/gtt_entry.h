...
#define GNOME_ENTRY(obj)                                                      \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), GNOME_TYPE_ENTRY, GnomeEntry))
#define GNOME_ENTRY_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_CAST ((klass), GNOME_TYPE_ENTRY, GnomeEntryClass))
#define GNOME_IS_ENTRY(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GNOME_TYPE_ENTRY))
#define GNOME_IS_ENTRY_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), GNOME_TYPE_ENTRY))
...
void gnome_entry_prepend_history (GnomeEntry *gentry, gboolean save,
                                  const gchar *text);
void gnome_entry_append_history (GnomeEntry *gentry, gboolean save,
                                 const gchar *text);
