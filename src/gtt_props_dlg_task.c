...
prop_task_dialog_new (void)
{
  ...
  GtkWidget *const task_properties = gtk_dialog_new ();
  ...
  g_signal_connect (help_button, "clicked", G_CALLBACK (gtt_help_popup),
                    "properties");
  ...
  g_signal_connect (okbutton1, "clicked", G_CALLBACK (close_cb), dlg);
  gtk_widget_show (okbutton1);

  gtk_box_pack_start (GTK_BOX (action_area), okbutton1, TRUE, TRUE, 0);
  ...
  g_signal_connect (G_OBJECT (memo_box), "changed",
  ...
  dlg->notes = GTK_TEXT_VIEW (notes_box);
  ...
  GtkTextBuffer *const notes_box_buffer
      = gtk_text_view_get_buffer (GTK_TEXT_VIEW (notes_box));
  g_signal_connect (G_OBJECT (notes_box_buffer), "changed",
                    G_CALLBACK (save_task_notes), dlg);
  ...
  gtk_table_attach (GTK_TABLE (task_table), scrolledwindow1, 1, 2, 1, 2,
  ...
  g_signal_connect (G_OBJECT (unit_box), "changed",
                    G_CALLBACK (save_task_billinfo), dlg);
  gtk_widget_show (unit_box);

  gtk_widget_show (entry4);

  gtk_table_attach (GTK_TABLE (task_table), entry4, 1, 2, 3, 4,
                    GTK_EXPAND | GTK_FILL, 0, 0, 0);

  gtk_widget_show (task_table);

  GtkWidget *const label5 = gtk_label_new (_ ("Diary Notes"));
  ...
  gtk_notebook_append_page (GTK_NOTEBOOK (notebook), task_table, label5);
  ...
  dlg->billstatus = GTK_OPTION_MENU (billstatus_menu);
  ...
  g_signal_connect (G_OBJECT (convertwidget12), "selection_done",
                    G_CALLBACK (save_task_billinfo), dlg);
  gtk_widget_show (convertwidget12);

  gtk_option_menu_set_menu (GTK_OPTION_MENU (billstatus_menu),
                            convertwidget12);
  ...
  dlg->billable = GTK_OPTION_MENU (billable_menu);
  ...
  g_signal_connect (G_OBJECT (convertwidget8), "selection_done",
                    G_CALLBACK (save_task_billinfo), dlg);
  gtk_widget_show (convertwidget8);

  gtk_option_menu_set_menu (GTK_OPTION_MENU (billable_menu), convertwidget8);
  ...
  dlg->billrate = GTK_OPTION_MENU (billrate_menu);
  ...
  g_signal_connect (G_OBJECT (convertwidget3), "selection_done",
                    G_CALLBACK (save_task_billinfo), dlg);
  gtk_widget_show (convertwidget3);

  gtk_option_menu_set_menu (GTK_OPTION_MENU (billrate_menu), convertwidget3);
  ...
  gtk_misc_set_alignment (GTK_MISC (label9), 0.5, 0.5);
  gtk_misc_set_padding (GTK_MISC (label9), 0, 0);
  gtk_widget_set_name (label9, "label9");
  gtk_widget_show (label9);

  gtk_notebook_append_page (GTK_NOTEBOOK (notebook), table1, label9);
