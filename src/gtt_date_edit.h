...
#define GNOME_IS_DATE_EDIT(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GNOME_TYPE_DATE_EDIT))
#define GNOME_IS_DATE_EDIT_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), GNOME_TYPE_DATE_EDIT))
...
GtkWidget *gnome_date_edit_new (time_t the_time, gboolean show_time,
...
void gnome_date_edit_construct (GnomeDateEdit *gde, time_t the_time,
                                GnomeDateEditFlags flags);
