...
#define gnome_util_prepend_user_home(x)                                        \
	(g_build_filename(g_get_home_dir(), (x), NULL))
...
#define gnome_util_home_file(afile)                                            \
	(g_build_filename(g_get_home_dir(), GNOME_DOT_GNOME, (afile), NULL))
...
#define gnome_libdir_file(f)                                                   \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_LIBDIR, (f), TRUE, NULL))
#define gnome_datadir_file(f)                                                  \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_DATADIR, (f), TRUE, NULL))
#define gnome_sound_file(f)                                                    \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_SOUND, (f), TRUE, NULL))
#define gnome_pixmap_file(f)                                                   \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_PIXMAP, (f), TRUE, NULL))
#define gnome_config_file(f)                                                   \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_CONFIG, (f), TRUE, NULL))

#define gnome_unconditional_libdir_file(f)                                     \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_LIBDIR, (f), FALSE, NULL))
#define gnome_unconditional_datadir_file(f)                                    \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_DATADIR, (f), FALSE, NULL))
#define gnome_unconditional_sound_file(f)                                      \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_SOUND, (f), FALSE, NULL))
#define gnome_unconditional_pixmap_file(f)                                     \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_PIXMAP, (f), FALSE, NULL))
#define gnome_unconditional_config_file(f)                                     \
	(gnome_program_locate_file(NULL, GNOME_FILE_DOMAIN_CONFIG, (f), FALSE, NULL))
