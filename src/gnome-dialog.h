...
#define GNOME_DIALOG(obj)                                                      \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), GNOME_TYPE_DIALOG, GnomeDialog))
#define GNOME_DIALOG_CLASS(klass)                                              \
	(G_TYPE_CHECK_CLASS_CAST((klass), GNOME_TYPE_DIALOG, GnomeDialogClass))
#define GNOME_IS_DIALOG(obj)                                                   \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), GNOME_TYPE_DIALOG))
#define GNOME_IS_DIALOG_CLASS(klass)                                           \
	(G_TYPE_CHECK_CLASS_TYPE((klass), GNOME_TYPE_DIALOG))
#define GNOME_DIALOG_GET_CLASS(obj)                                            \
	(G_TYPE_INSTANCE_GET_CLASS((obj), GNOME_TYPE_DIALOG, GnomeDialogClass))
...
void gnome_dialog_button_connect(GnomeDialog *dialog, gint button,
                                 GCallback callback, gpointer data);
/* Connect the object to the "clicked" signal of a single button */
void gnome_dialog_button_connect_object(GnomeDialog *dialog, gint button,
...
void gnome_dialog_set_sensitive(GnomeDialog *dialog, gint button,
                                gboolean setting);
...
/* Set the accelerator for a button. Note that there are two
   ...
   handler.) */
void gnome_dialog_set_accelerator(GnomeDialog *dialog, gint button,
...
void gnome_dialog_construct(GnomeDialog *dialog, const gchar *title,
                            va_list ap);
void gnome_dialog_constructv(GnomeDialog *dialog, const gchar *title,
                             const gchar **buttons);
...
void _gnome_marshal_BOOLEAN__VOID(GClosure *closure, GValue *return_value,
