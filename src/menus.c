...
#define MENU_PROJECTS_CUT_POS 2
     ...
     cut_project, NULL, NULL, GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_PIXMAP_CUT,
     'D', GDK_CONTROL_MASK, NULL},
#define MENU_PROJECTS_COPY_POS 3
		{GNOME_APP_UI_ITEM, N_("_Copy"), N_("Copy the selected project"),
     copy_project, NULL, NULL, GNOME_APP_PIXMAP_STOCK, GNOME_STOCK_PIXMAP_COPY,
...
#define MENU_PROJECTS_PASTE_POS 4
     ...
     paste_project, NULL, NULL, GNOME_APP_PIXMAP_STOCK,
     GNOME_STOCK_PIXMAP_PASTE, 'G', GDK_CONTROL_MASK, NULL},
		GNOMEUIINFO_SEPARATOR,
...
static GnomeUIInfo menu_main_reports[] = {
		...
		GNOMEUIINFO_ITEM_STOCK_DATA(N_("_To Do..."), N_("Show a sample to-do list"),
                                show_report, TODO_REPORT, GNOME_STOCK_BLANK),
		...
		GNOMEUIINFO_ITEM_STOCK_DATA(N_("_Query..."),
                                N_("Run a sample Query Generator"), show_report,
                                QUERY_REPORT, GNOME_STOCK_BLANK),
		GNOMEUIINFO_ITEM_STOCK_DATA(
				N_("_Primer..."),
